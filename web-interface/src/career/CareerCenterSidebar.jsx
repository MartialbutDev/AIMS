...
export default function CareerCenterSidebar({
  isOpen,
  onClose,
  currentPage,
  onNavigate,
        ...
        <div>
          <div className="p-5 border-b border-slate-100 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-base font-bold text-[#1a1642] leading-tight">Career Center</h2>
                <span className="text-xs text-slate-400 font-medium">Industry & MOA Panel</span>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between pt-2 border-t border-slate-100 px-2">
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <p className="text-xs font-bold text-slate-800 leading-tight">Career Services</p>
                <p className="text-[10px] text-slate-400">Placement Officer</p>
              </div>
            </div>
